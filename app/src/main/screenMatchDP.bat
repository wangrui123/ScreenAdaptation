...
:: For example:java -jar screenMatchDP.jar 375 609
:: Default dps is 384 392 400 410 411 480 533 592 600 609 640 662 720 768 800 811 820 960 961 1024 1280 1365
@java -Dfile.encoding=utf-8 -jar %~dp0\screenMatchDP.jar 375
